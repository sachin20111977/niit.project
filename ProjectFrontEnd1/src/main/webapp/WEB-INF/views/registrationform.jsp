...
$(document).ready(function(){
	$('#form').validate({
		rules:{
			...
			"billingaddress.apartmentnumber":{required:true,minlength:1},
			"billingaddress.streetname":{required:true,minlength:1},
			"billingaddress.state":{required:true,minlength:1},
			"billingaddress.city":{required:true,minlength:1},
			"billingaddress.country":{required:true,minlength:1},
			"billingaddress.zipcode":{required:true,number:true,minlength:1}
		},
		messages:{
...
<div class="container">
	...
	<table></table>
	<tr><td>
	<form:label path="user.email">Enter Email:</form:label></td><td>
	<form:input path="user.email" id="user.email" type="email"/></td></tr><br>
	<span style="color:red">${errorMessage }</span><br>
	<tr><td><form:label path="user.password">Enter password:</form:label></td><td>
	<form:input path="user.password" id="user.password" type="password"  /></td></tr><br>
	<form:hidden path="user.enabled" value="true"/><br>
...
<input type="checkbox" onclick="fillShippingAddress(this.form)" id="shippingaddressform">
	...
	<form:label path="shippingaddress.country">Enter country<br></form:label>
	<form:input path="shippingaddress.country" id="shippingaddress.country"/>
	
	<form:label path="shippingaddress.zipcode">Enter zipcode<br></form:label>
